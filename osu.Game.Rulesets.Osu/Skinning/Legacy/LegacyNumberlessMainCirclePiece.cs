...
{
    public partial class LegacyNumberlessMainCirclePiece : CompositeDrawable
    {
        ...
        public LegacyNumberlessMainCirclePiece(string? priorityLookupPrefix = null, bool hasNumber = true)
        {
